...
\begin{figure*}[p]
\centering
\includegraphics[width=0.9\textwidth]{inf-ai_c_2.pdf}
\vspace*{5mm}

\scalebox{0.7}{
\begin{tikzpicture}
	\node[anchor=north, inner sep=0] (tg) at (0,0) {
 		   \includegraphics[width=0.15\textwidth]{tglider.pdf}
	};
	\node[anchor=north, inner sep=0] (bg) at (3,0) {
 		   \includegraphics[width=0.15\textwidth]{bglider.pdf}
	};
	\node[anchor=north, inner sep=0] (pl) at (6,0) {
 		   \includegraphics[width=0.15\textwidth]{plane.pdf}
	};
	\node[anchor=north, inner sep=0] (sp) at (9,0) {
 		   \includegraphics[width=0.15\textwidth]{spiral.pdf}
	};
	
	\node[anchor=north, inner sep=0] (ho) at (-1.8,-3) {
 		   \includegraphics[width=0.13\textwidth]{horn.pdf}
	};
	\node[anchor=north, inner sep=0] (ka) at (1,-3) {
 		   \includegraphics[width=0.11\textwidth]{kar.pdf}
	};
	\node[anchor=north, inner sep=0] (ro) at (4,-3) {
 		   \includegraphics[width=0.15\textwidth]{roof.pdf}
	};
	\node[anchor=north, inner sep=0] (fa) at (7.5,-3) {
 		   \includegraphics[width=0.2\textwidth]{fault.pdf}
	};
	\node[anchor=north, inner sep=0] (ci) at (10.8,-3) {
 		   \includegraphics[width=0.15\textwidth]{cliff.pdf}
	};
...
\begin{tabular}{c}
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=\linewidth]{Fnt_1.pdf}
 \end{minipage}
 ...
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=\linewidth]{Fnb_1.pdf}
...
\begin{tabular}{c}
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=\linewidth]{F0_1.pdf}
 \end{minipage}
 \begin{minipage}{0.05\linewidth}
 \ \\
 \end{minipage} 
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=\linewidth]{F1_1.pdf}
...
\begin{tabular}{c}
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=\linewidth]{Lt_3.pdf}
 \end{minipage}
 \begin{minipage}{0.05\linewidth}
 \ \\
 \end{minipage} 
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=\linewidth]{Lbc_3.pdf}
...
\begin{tabular}{c}
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=0.8\linewidth]{Ltrc_3.pdf}
 \end{minipage}
  \begin{minipage}{0.05\linewidth}
 \ \\
 \end{minipage} 
  \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=\linewidth]{Ltre_3.pdf}
 \end{minipage}
 \end{tabular}

  \centering
   \includegraphics[width=0.5\linewidth]{Lbe_3.pdf}
...
In zigs, L folds into either \texttt{Lt} or \texttt{Lbn} depending on where it starts, until the transcript reaches the left end, where L folds either into \texttt{Lcrn} if the current counter value has not been overflowed, or into \texttt{Lbe} at an overflow.
...
\begin{tabular}{c}
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=0.9\linewidth]{H00_1.pdf}
 \end{minipage}
  \begin{minipage}{0.05\linewidth}
 \ \\
 \end{minipage} 
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=0.9\linewidth]{H01_1.pdf}
...
\ \\
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=0.9\linewidth]{H10_1.pdf}
 \end{minipage}
 \begin{minipage}{0.05\linewidth}
 \ \\
 \end{minipage} 
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=0.9\linewidth]{H11_1.pdf}
 \end{minipage}
...
\ \\
  \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=0.9\linewidth]{He1_1.pdf}
 \end{minipage}
  \begin{minipage}{0.05\linewidth}
 \ \\
 \end{minipage} 
  \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=0.9\linewidth]{Hn_1.pdf}

 \end{minipage}
 \end{tabular}

 \caption{All the six bricks of module H: \texttt{H00}, \texttt{H01}, \texttt{H10}, \texttt{H11}, \texttt{He1}, and \texttt{Hn} from top left to bottom right.
...
\begin{tabular}{c}
 \begin{minipage}{0.5\linewidth}
  \centering
   \includegraphics[width=0.9\linewidth]{Rt_1.pdf}\\
   \vspace*{3mm}
   
   \includegraphics[width=0.9\linewidth]{Rb_1(2).pdf}\\
   \vspace*{2mm}
   \includegraphics[width=0.9\linewidth]{Rb_1.pdf}
 \end{minipage}
 
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=0.7\linewidth]{Rtr_1.pdf}
 \end{minipage}
 \end{tabular}
...
%\texttt{124}{-}\texttt{125}{-}\texttt{126}{-}\texttt{127}{-}\texttt{128}{-}\texttt{129}{-} \texttt{130}{-}$ $
...
\centering
\includegraphics[width=\linewidth]{CounterEx17_3.pdf}
...
\centering
\includegraphics[width=\linewidth]{CounterEx18_2.pdf}
...
The infinite counter was used to simulate countably many Turing machines in parallel for proving the undecidability of problems on aTAM in \cite{BrChDoKaSe2013,LathropLPS2011}. 
The inherent sequentiality of oritatami prevents the proposed counter from being utilized alike or at least makes such applications highly non-trivial. 
The real significance of this counter in practice is that it can be embedded into a large-scale system as a counting module that can transition at an overflow into another phase, which does not have to do bit-expansion. 
