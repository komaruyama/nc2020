...
In this paper, we shall endow this counter, or more precisely, its structural module $B$, with the capability of overflow detection and bit-expansion thereof. 
...
In the read-once-write-once models of computation such as oritatami, abstract tile-assembly model (aTAM) \cite{RothemundWinfree2000,WinfreePhD}, and many other models of molecular self-assembly, however, what a computation matters is not so much an output obtained conclusively but rather a shape self-assembled in the course. 
Unless being interlocked geometrically, the output cannot wire to an input of another computation. 
The versatile systems in oritatami \cite{GeMeScSe2018,PchelinaSSU2020} hence never discourage us to design a set of single-function modules of simple enough shape to be wired, preferably via a common interface. 
...
\begin{tabular}{c}
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=\linewidth]{fig/svg/Fnt_1.pdf}
 \end{minipage}
 ...
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=\linewidth]{fig/svg/Fnb_1.pdf}
...
\begin{tabular}{c}
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=\linewidth]{fig/svg/F0_1.pdf}
 \end{minipage}
 \begin{minipage}{0.05\linewidth}
 \ \\
 \end{minipage} 
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=\linewidth]{fig/svg/F1_1.pdf}
...
\begin{tabular}{c}
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=\linewidth]{fig/svg/Lt_3.pdf}
 \end{minipage}
 \begin{minipage}{0.05\linewidth}
 \ \\
 \end{minipage} 
 \begin{minipage}{0.45\linewidth}
  \centering
   \includegraphics[width=\linewidth]{fig/svg/Lbc_3.pdf}
...
\begin{tabular}{c}
 \begin{minipage}{0.5\linewidth}
  \centering
   \includegraphics[width=0.9\linewidth]{fig/svg/Rt_1.pdf}\\
   \vspace*{3mm}
   
   \includegraphics[width=0.9\linewidth]{fig/svg/Rb_1(2).pdf}\\
   \vspace*{2mm}
   \includegraphics[width=0.9\linewidth]{fig/svg/Rb_1.pdf}
 \end{minipage}
