...
The capability of handling overflows enables the system to launch at a simplest possible seed which encodes nothing but a Turn Signal for the first right turn as long as the system starts counting from 0 (see Fig.~\ref{}). 
